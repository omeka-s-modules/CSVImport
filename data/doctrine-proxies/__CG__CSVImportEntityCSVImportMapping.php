 ...
 */
class CSVImportMapping extends \CSVImport\Entity\CSVImportMapping implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CSVImportMapping $proxy) {
