...
class Module extends AbstractModule
{
    ...
    public function install(ServiceLocatorInterface $serviceLocator)
    {
        ...
        $sql = "
        CREATE TABLE csvimport_record (id INT AUTO_INCREMENT NOT NULL, job_id INT NOT NULL, item_id INT DEFAULT NULL, INDEX IDX_11CF590DBE04EA9 (job_id), UNIQUE INDEX UNIQ_11CF590D126F525E (item_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB;
